...
# Answer: Both point distributions, regular and sports, are bimodial with two modes of student count values. The peaks for the regular section are at 40 & 30, and the peaks for the sports section are both at 30.
